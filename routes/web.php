...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('markasread/{id}/{typeId}', [IssuenceController::class, 'markasread'])->name('markasread');
    ...
    Route::get('markasread-transfer/{id}/{typeId}', [IssuenceController::class, 'markasreadTransfer'])->name('markasread-transfer');
    ...
    Route::get('markasread-manager-return/{id}/{typeId}', [IssuenceController::class, 'markasreadmanagerreturn'])->name('markasread-manager-return');
    Route::get('markasread-manager-transferaccept/{id}', [IssuenceController::class, 'markasreadmanagertransferaccept'])->name('markasread-manager-transferaccept');
    Route::get('markasread-transfer-manager/{id}/{typeId}', [IssuenceController::class, 'markasreadTransfermanager'])->name('markasread-transfer-manager');
    ...
    Route::get('/getPDF', [ReportController::class, 'generatePDF'])->name('getPDF');
    ...
    //Print
    Route::get('/getPrint', [ReportController::class, 'getPrint'])->name('getPrint');
    ...
    Route::get('maintenance/apply', [MaintenanceController::class, 'maintenanceUser'])->name('user.apply');
    Route::post('maintenance/apply', [MaintenanceController::class, 'sendUser'])->name('user.send');
    Route::get('maintenance/applications', [MaintenanceController::class, 'application'])->name('all-applications');
    Route::get('markasread/applications/{id}', [MaintenanceController::class, 'markasreadapplication'])->name('markasread-applications');
    Route::get('report/maintenance/{id}', [MaintenanceController::class, 'report_maintenance'])->name('report.maintenance');
