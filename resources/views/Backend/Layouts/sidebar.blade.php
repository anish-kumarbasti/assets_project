            ...
            <ul class="sidebar-links" id="simple-bar">
                ...
                @can('view_general_setting')
                    <li class="sidebar-list {{ request()->is(['application-setting*', 'send-email*']) ? 'active' : '' }}">
                        <a class="sidebar-link sidebar-title" href="javascript:void(0)"><i data-feather="settings"
                ...
                @can('view_issuence')
                    <li class="sidebar-list {{ request()->is(['issuences*', 'issuences/all*']) ? 'active' : '' }}">
                        <a class="sidebar-link sidebar-title" href="javascript:void(0)"><i
                                data-feather="box"></i><span>Issuence</span></a>
                        <ul class="sidebar-submenu">
                ...
                @can('view_transfer')
                    <li class="sidebar-list {{ request()->is(['transfer*', 'transfer/all*']) ? 'active' : '' }}">
                        <a class="sidebar-link sidebar-title" href="javascript:void(0)"><i
                                data-feather="list"></i><span>Transfer</span></a>
                        <ul class="sidebar-submenu">
