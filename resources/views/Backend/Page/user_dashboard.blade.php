    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card o-hidden product-widget">
        <div class="card-header pb-0">
          <div class="d-flex">
            <div class="flex-grow-1">
              <p class="square-after f-w-600 header-text-success">Transfered<i class="fa fa-circle"> </i></p>
              <h4>0</h4>
            </div>
            <div class="d-flex static-widget">
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card o-hidden message-widget">
        <div class="card-header pb-0">
          <div class="d-flex">
            <div class="flex-grow-1">
              <p class="square-after f-w-600 header-text-secondary">Requests<i class="fa fa-circle"> </i></p>
              <h4>0</h4>
            </div>
            <div class="d-flex static-widget">
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card o-hidden user-widget">
        <div class="card-header pb-0">
          <div class="d-flex">
            <div class="flex-grow-1">
              <p class="square-after f-w-600 header-text-info">Pending Assets<i class="fa fa-circle"> </i></p>
              <h4>0</h4>
            </div>
            <div class="d-flex static-widget">
