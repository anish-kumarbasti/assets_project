...
@section('Content-Area')
    @if (session('success'))
        <div id="login" class="alert alert-success inverse alert-dismissible fade show" role="alert"><i
                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-primary">Total Issued<i class="fa fa-circle">
                                    </i></p>
                                <h4>0</h4>
                            </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden product-widget">
                    <div class="card-header pb-0">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-success">Transfered<i class="fa fa-circle"> </i>
                                </p>
                                <h4>0</h4>
                            </div>
                            <div class="d-flex static-widget">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden message-widget">
                    <div class="card-header pb-0">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-secondary">Requests<i class="fa fa-circle"> </i>
                                </p>
                                <h4>0</h4>
                            </div>
                            <div class="d-flex static-widget">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden user-widget">
                    <div class="card-header pb-0">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-info">Pending Assets<i class="fa fa-circle"> </i>
                                </p>
                                <h4>0</h4>
                            </div>
                            <div class="d-flex static-widget">
                ...
                <div class="card appointment-detail">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-primary">Asset Requests<i class="fa fa-circle">
                                    </i>
                                </p>
                                        ...
                                        <form
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex"><img class="img-fluid align-top circle"
                                                        ...
                                                        <div class="flex-grow-1"><a
                                                            ...
                                                            <p class="mb-0">
                                                                @foreach ($createdDates as $createtime)
                                                                    {{ Carbon\Carbon::parse($createtime)->diffForHumans() }}
                                                                @endforeach
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>Hello User A new Asset ({{ $product->product_info }}) has been
                                                    issued
                                                    Kindly Check the Notification please!</td>
                                            </tr>
                                        </form>
                                    @endforeach
                                </tbody>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex"><img class="img-fluid align-top circle" src="../assets/images/dashboard/default/01.png" alt="">
                                  <div class="flex-grow-1"><a href="user-profile.html"><span>Hp Laptop 512GB1TB</span></a>
                                    <p class="mb-0">1 Hour</p>
                                  </div>
                                  <div class="active-status active-online"></div>
                                </div>
                              </td>
                              <td>Hello User A new Asset (HP Laptop 512GB1TB) has been issued please accept to the request</td>
                              <td class="text-end">
                                <button class="btn btn-primary" type="button" onclick="document.location='user-cards.html'">Accept</button>

                              </td>
                              <td class="">
                                <button class="btn btn-danger" type="button" onclick="document.location='user-cards.html'">Reject</button>
