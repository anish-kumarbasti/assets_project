    ...
    <div class="col-sm-6 col-lg-3">
                 <div class="card o-hidden">
                   <div class="card-header pb-0">
                     <div class="d-flex">
                       <div class="flex-grow-1">
                         <p class="square-after f-w-600 header-text-primary">Stolen<i class="fa fa-circle"> </i></p>
                         <h4>0</h4>
                       </div>
                       <div class="d-flex static-widget">
                         <svg class="fill-primary" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="col-sm-6 col-lg-3">
                 <div class="card o-hidden product-widget">
                   <div class="card-header pb-0">
                     <div class="d-flex">
                       <div class="flex-grow-1">
                         <p class="square-after f-w-600 header-text-success">Lost<i class="fa fa-circle"> </i></p>
                         <h4>0</h4>
                       </div>
                       <div class="d-flex static-widget">
                         <svg class="fill-success" width="45" height="45" viewBox="0 0 45 39" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="col-sm-6 col-lg-3">
                 <div class="card o-hidden user-widget">
                   <div class="card-header pb-0">
                     <div class="d-flex">
                       <div class="flex-grow-1">
                         <p class="square-after f-w-600 header-text-info">Broken<i class="fa fa-circle"> </i></p>
                         <h4>0</h4>
                       </div>
                       <div class="d-flex static-widget">
                         <svg class="fill-info" width="41" height="46" viewBox="0 0 41 46" xmlns="http://www.w3.org/2000/svg">
...
<div class="row">
  <div class="col-md-4">
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card card-item">
          <div class="card-body">
            <h3 class="text-center first-heading">564</h3>
  ...
  <h4 class="py-4">Users Who have more then 1 Asset</h4>
  </div>
  <div class="row mt-4">
  ...
  <div class="row home-item-1 mb-4">
    <div class="col-md-4 home-card-item">
    <div class="card-1">
  <div class="card-body">
    <h5 class="card-title">
                        ...
                        <div class="widget-card">
                          <div class="d-flex align-self-center">
                            <div class="flex-grow-1">
                              ...
                              <p><span class="counter">Left :</span><span class="font-primary ms-1">5</span> <span> <i class="icon-arrow-right icofontt ican-item-1 font-primary"></i> </span></p>
                            </div>
                          </div>
                        </div>
                         </div>
                        ...
                        <div class="widget-card">
                          <div class="d-flex align-self-center">
                            ...
                            <div class="flex-grow-1">
                              <h6 class="heading-item">Laptop Bag 14 inch </h6>
                              <h5><span class="counter">Assigned :</span><span class="font-primary ms-1">20</span></h5>
                              <p><span class="counter">Left :</span><span class="font-primary ms-1">5</span> <span class="bg-light-primary"> <i class="icon-arrow-right ican-item-1 icofontt font-primary"></i> </span></p>
                            </div>
                          </div>
                        </div>
                        </div>
