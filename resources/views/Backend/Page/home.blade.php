        ...
        <div class="card-header pb-0">
          <div class="d-flex">
            ...
            <div class="d-flex static-widget">
              <svg width="68" height="68" viewBox="0 0 1024 1024" class="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M500.5 441.4m-59.5 0a59.5 59.5 0 1 0 119 0 59.5 59.5 0 1 0-119 0Z" fill="#005BFF" /><path d="M329.9 793.1c-1.5 0-3-0.3-4.5-1.1-68.7-34.3-125.4-87.6-164-154.1-2.8-4.8-1.2-10.9 3.6-13.7 4.8-2.8 10.9-1.2 13.7 3.6 36.6 63.1 90.5 113.6 155.6 146.2 4.9 2.5 6.9 8.5 4.5 13.4-1.7 3.7-5.3 5.7-8.9 5.7z" fill="#005BFF" />
...
<svg viewBox="0 0 1024 1024" class="fill-primary" width="68" height="68"   version="1.1" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="card o-hidden message-widget">
        <div class="card-header pb-0">
          <div class="d-flex">
            ...
            <div class="d-flex static-widget">
                <svg width="68" height="68" viewBox="0 0 1024 1024" class="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M724.38 121.82H659a2.63 2.63 0 0 0-2.61 2.66V264.4a2.63 2.63 0 0 1-2.61 2.66H379.49a2.63 2.63 0 0 1-2.61-2.66V127.87a6 6 0 0 0-6-6.06h-64.77a30.68 30.68 0 0 0-29.89 24.6l-39.81 190a2.64 2.64 0 0 0 2.56 3.21h552.55a2.64 2.64 0 0 0 2.56-3.21l-39.81-190a30.68 30.68 0 0 0-29.89-24.59z" fill="#E6E6E6" />
                    ...
                    <path d="M238.32 368.38c-12.75 0-23.08-10.6-23.08-23.68s10.33-23.68 23.08-23.68h553.85c12.75 0 23.08 10.6 23.08 23.68s-10.33 23.68-23.08 23.68" fill="#FFFFFF" /><path d="M792.17 375.88a7.5 7.5 0 0 1 0-15c8.59 0 15.58-7.26 15.58-16.18s-7-16.17-15.58-16.17H238.32c-8.59 0-15.58 7.26-15.58 16.17s7 16.18 15.58 16.18a7.5 7.5 0 0 1 0 15c-16.86 0-30.58-14-30.58-31.18s13.72-31.17 30.58-31.17h553.85c16.86 0 30.58 14 30.58 31.17s-13.75 31.18-30.58 31.18z" fill="#66A9F7" />
                    ...
                    <path d="M655 275.43H375.5a7.5 7.5 0 0 1-7.5-7.5V108.52A37.54 37.54 0 0 1 405.5 71H625a37.54 37.54 0 0 1 37.5 37.5v159.43a7.5 7.5 0 0 1-7.5 7.5z m-272-15h264.5V108.52A22.53 22.53 0 0 0 625 86H405.5a22.53 22.53 0 0 0-22.5 22.5z" fill="#66A9F7" /></svg>
          ...
          <div class="d-flex">
            ...
            <div class="d-flex static-widget">
              <svg width="68" height="68" viewBox="0 0 1024 1024" class="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M370.1 737.5l13.7 7.3c15.6 8.2 33 15.6 51.3 21.1l14.7 4.6v68.7c0 16.5 11 20.2 20.2 20.2h82.4c9.2 0 20.2-3.7 20.2-20.2v-68.7l14.7-4.6c18.3-5.5 35.7-12.8 51.3-21.1l13.7-7.3 11 11c19.2 19.2 32.1 33 37.6 36.6 4.6 4.6 9.2 7.3 13.7 7.3 8.2 0 15.6-6.4 15.6-7.3l58.6-58.6c6.4-6.4 11.9-17.4 0-29.3l-48.5-48.5 7.3-13.7c8.2-15.6 15.6-33 21.1-51.3l4.6-14.7H842c16.5 0 20.2-11 20.2-20.2v-82.4c0-9.2-3.7-20.2-20.2-20.2h-68.7l-4.6-14.7c-6.4-17.4-12.8-34.8-22-50.4l-7.3-13.7 11-11 37.6-37.6c4.6-4.6 7.3-9.2 7.3-13.7 0-6.4-4.6-12.8-7.3-15.6L729.2 231c-1.8-1.8-8.2-7.3-15.6-7.3-4.6 0-9.2 1.8-13.7 7.3l-48.5 48.5-13.7-7.3c-15.6-8.2-33-15.6-50.4-21.1l-14.7-3.7v-69.6c0-17.4-14.7-20.2-21.1-20.2H470c-6.4 0-20.2 2.7-20.2 20.2v69.6l-14.7 4.6c-17.4 5.5-34.8 11.9-50.4 21.1l-13.7 7.3-49.4-49.4c-4.6-4.6-9.2-6.4-12.8-6.4-7.3 0-14.7 5.5-16.5 7.3l-58.6 57.7c-3.7 4.6-12.8 16.5 0 29.3l48.5 48.6-7.3 13.7c-8.2 15.6-15.6 33-21.1 50.4l-4.6 14.7h-68.7c-16.5 0.9-20.2 13.7-20.2 22v81.5c0 6.4 2.7 20.2 20.2 20.2h68.7l4.6 14.7c5.5 18.3 12.8 34.8 21.1 51.3l7.3 13.7-48.5 48.5c-11.9 11.9-4.6 23.8 0 29.3l57.7 57.7c1.8 0.9 9.2 6.4 15.6 6.4 4.6 0 8.2-1.8 12.8-6.4l50.3-47.7z" fill="#FFFFFF" />
                ...
                <path d="M838.5 772.8c-2.4 0-4.9-0.9-6.8-2.7L668.1 618.7c-4.1-3.8-4.3-10.1-0.5-14.1 3.8-4.1 10.1-4.3 14.1-0.5l163.6 151.4c4.1 3.8 4.3 10.1 0.5 14.1-2 2.1-4.7 3.2-7.3 3.2z" fill="#06F3FF" /></svg>
            </div>
          </div>
        </div>
          ...
          <div class="d-flex">
            ...
            <div class="d-flex static-widget">
                <svg width="68" height="68" viewBox="0 0 1024 1024" class="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M117.4 504.1s-0.1 0-0.1-0.1c0 0 0.1 0 0.1 0.1z" fill="#06F3FF" /></svg>
            </div>
          </div>
        </div>
      ...
      <div class="card o-hidden product-widget">
        <div class="card-header pb-0">
          <div class="d-flex">
            ...
            <div class="d-flex static-widget">
              <svg width="68" height="68" viewBox="0 0 1024 1024" class="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M325.8 819.6h-55c-38.6 0-70-31.4-70-70V510.1c0-38.6 31.4-70 70-70h55c38.6 0 70 31.4 70 70v239.5c0 38.6-31.4 70-70 70z m-54.9-339.5c-16.5 0-30 13.5-30 30v239.5c0 16.5 13.5 30 30 30h55c16.5 0 30-13.5 30-30V510.1c0-16.5-13.5-30-30-30h-55z" fill="#005BFF" />
      ...
      <div class="card o-hidden user-widget">
        <div class="card-header pb-0">
          <div class="d-flex">
            ...
            <div class="d-flex static-widget">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84 84" width="68" height="68">
                    <g>
