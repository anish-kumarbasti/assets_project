                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('import.store.department') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <a href="{{ route('import.download-format') }}" class="btn btn-secondary">Download Format</a>
                        ...
                        <div class="card-item">
                            <div class="row p-3">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input class="form-control mb-2" id="validationCustom01" type="text"
                                        value="{{ old('name') }}" name="name" required="" data-bs-original-title=""
                                        title="" placeholder="Enter Department Name">
                                    @error('name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    <label class="form-label" for="validationCustom02">Department Id</label>
                                    <input class="form-control" id="validationCustom02" type="text" value="DEP"
                                        name="unique" required="" data-bs-original-title="" title=""
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <button class="btn btn-danger delete-button" type="button"
                                                    data-id="{{ $department->id }}"><i class="fa fa-trash-o"></i>
                                                    Delete</button>
                                            </div>
                                        </td>
                                    </tr>
