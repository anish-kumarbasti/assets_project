            ...
            <div class="card-header pb-0 d-flex">
                ...
                <div class="col-sm-6">
                    @can('create_designation')
                        <a href="{{ route('designation.trash') }}" class="btn btn-danger float-end"
                            style="margin-left: 5px;">Trash</a><a href="{{ route('designations.create') }}"
                            class="btn btn-primary float-end"><i class="fa fa-plus"></i> Add Designation</a>
                    @endcan
                </div>
            </div>
