        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('import-reason') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="select_file">Choose File:</label>
                            <input type="file" name="select_file" class="form-control" accept=".xls, .xlsx">
                        </div>
                        <a href="{{ route('import.download-format-reason') }}" class="btn btn-secondary">Download
                            Format</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger delete-button" type="button"
                                                data-id="{{ $reason->id }}"><i class="fa fa-trash-o"></i>
                                                Trash</button>
                                        </td>
                                    </tr>
                                @endforeach
