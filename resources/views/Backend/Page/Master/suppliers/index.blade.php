            ...
            <div class="row">
                <div class="col s10 m6 l6">
                    <ol class="breadcrumbs mb-2">
                        ...
                        <li class="active"><a href="{{ url('suppliers') }}">Supplier</a></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header pb-0 d-flex">
                ...
                <div class="col-sm-6"><a href="{{ route('trash.suppliers') }}" class="btn btn-danger float-end"
                        style="margin-left: 5px;">Trash</a><a href="{{ route('suppliers.create') }}"
                        class="btn btn-primary float-end"><i class="fa fa-plus"></i>&nbsp;Create Suppliers</a>
                </div>
            </div>
            <div class="card-body">
