...
@section('Content-Area')
    @if (session('success'))
        <div id="alert-success" class="alert alert-success inverse alert-dismissible fade show" role="alert"><i
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('import.store.brandmodel') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="select_file">Choose File:</label>
                                    <input type="file" name="select_file" class="form-control" accept=".xls, .xlsx">
                                </div>
                                <a href="{{ route('import.download-format-brandmodel') }}" class="btn btn-secondary">Download
                                    Format</a>
                ...
                <form class="needs-validation" action="{{ route('brand-model.store') }}" method="post">
                    ...
                    <div class="card-item">
                        ...
                        <div class="footer-item">
                            <button class="btn btn-primary mt-3" type="submit" data-bs-original-title="" title="">
                                Add</button>
                        </div>
                    </div>
                </form>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary"
                                                href="{{ url('brand-model/' . $brandmodel->id . '/edit') }}"><i
                                                    class="fa fa-pencil"></i>&nbsp;Edit</a>
                                            <button class="btn btn-danger delete-button" type="button"
                                                data-id="{{ $brandmodel->id }}"><i
