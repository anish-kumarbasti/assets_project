            ...
            <section class="cd-container" id="cd-timeline">
              <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                  <h4>1. In Stock</h4>
                  <p class="m-0">Date & Time of Adding The Product in InStock</p><p>02/04/2023 at 05:30 PM </p><span class="cd-date f-w-600">Jan <span class="counter"> 14</span></span>
                </div>
              </div>
              <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                  ...
                  </div><p>Date & Time of Allocating The Product to User</p><a style="color:rgba(107, 107, 107, 0.564);">02/04/2023 at 05:30 PM</a><span class="cd-date f-w-600">Jan <span class="counter">18</span></span>
                </div>
              </div>
              <div class="cd-timeline-block">
                <div class="cd-timeline-img cd-picture icon">3</div>
                <div class="cd-timeline-content">
                  <h4>3. Handover to Manager</h4><div class="bg-white">
                  <p style="font-size:15px;">Rakesh Singh <a style="color:rgba(107, 107, 107, 0.564);">(Manager)</a></p>
                  <p>Mobile: <a style="color:rgba(107, 107, 107, 0.564);">9885354568</a></p>
                  <p>E-mail: <a style="color:rgba(107, 107, 107, 0.564);">demo@gmail.com</a></p>
                </div><p>Date & Time of Handover The Product to Manager</p><a style="color:rgba(107, 107, 107, 0.564);">02/04/2023 at 05:30 PM</a><span class="cd-date f-w-600">Jan <span class="counter">24</span></span>
                </div>
              </div>
              <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                  ...
                  <div class="bg-white">
                    ...
                    <p>Mobile: <a style="color:rgba(107, 107, 107, 0.564);">9885354568</a></p>
                    <p>E-mail: <a style="color:rgba(107, 107, 107, 0.564);">demo@gmail.com</a></p>
                  </div><p>Date & Time of Allocating The Product to User</p><a style="color:rgba(107, 107, 107, 0.564);">02/04/2023 at 05:30 PM</a>
