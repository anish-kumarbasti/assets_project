...
@endif
<div class="col-sm-12 date-picker">
    <form class="needs-validation theme-form" method="POST" action="{{ isset($stockedit) ? route('update.stock', $stockedit->id) : route('store.stock') }}">
        @csrf
        <div class="card">
