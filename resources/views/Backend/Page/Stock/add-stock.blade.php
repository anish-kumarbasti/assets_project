        ...
        <form class="needs-validation" method="POST"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-item border" id="allbrand">
                        <div class="row p-3">
                        ...
                        <div class="row p-3">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" value="{{ isset($stockedit) ? $stockedit->product_info : '' }}"
                                    id="validationCustom01" type="text" name="product_info" data-bs-original-title="" title="" placeholder="Enter Product Info">
                            </div>
                            <div class="col-md-4 mb-4" id="serial_number_label">
                            ...
                            <div class="col-md-4 mb-4" id="quantityField">
                              ...
                              <input class="form-control" id="validationCustom01" type="text" name="quantity"
                            ...
                            <div class="col-md-4 mb-4" id="licenseNumberField">
                              ...
                              <input class="form-control" id="validationCustom01" type="text" name="license_number"
                                  data-bs-original-title="" title="" placeholder="Enter License Number">
                          </div>
                            <div class="col-md-4">
                                <label class="form-label" style="float: left;">Asset Code :</label><a href="#"
                                    style="float: left;">Generate Number</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#assettype').change(function() {
                ...
                // alert(selectedAssetTypeId);
                // Make an AJAX call to fetch data from the server
                $.ajax({
                    url: '/get-asset-details/' +
                    selectedAssetTypeId, // Replace with your actual route
                    method: 'post',
                    data: 'selectedAssetTypeId' + selectedAssetTypeId +
                        '&_token={{ csrf_token() }}',
                    success: function(data) {
                        ...
                        if (data.assetType === 'Non IT Asset') {
                            // Show quantity and specification fields
                            $('#quantityField, #specificationField,#allbrand').show();
                            $('#serial_number_label, #configuration').hide();
                        } else if (data.assetType === 'Asset Component') {
                            // Show quantity and specification fields
                            $('#quantityField, #specificationField,#allbrand').show();
                            $('#serial_number_label, #configuration').hide();
                            ...
                            $('#serial_number_label, #warranty, #allbrand').hide();
                        } else {
                            // Default: Show serial number field only
                            $('#serial_number_label, #configuration, #warranty, #allbrand').show();
                            $('#licenseNumberField, #expiryField, #specificationField').hide();
                        }
                    }
                });
            });
