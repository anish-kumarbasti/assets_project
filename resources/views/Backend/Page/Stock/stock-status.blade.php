                    ...
                    <div class="col-md-12 d-flex justify-content-center flex-nowrap">
                        ...
                        <div class="col-md-2 border-right">
                            <a class="nav-link status-tab" href="#danger-stolen" aria-selected="true" data-toggle="tab"
                                data-status="stolen">Stolen
                        </div>
                        <div class="col-md-2 border-right">
                            <a class="nav-link status-tab sc" href="#danger-scrapped" aria-selected="true" data-toggle="tab"
                                data-status="scrapped">Scrapped</a>
                        </div>
                        <div class="col-md-2">
                            <a class="nav-link status-tab" href="#danger-lost" aria-selected="true" data-toggle="tab"
                                data-status="scrapped">Transfer</a>
                        </div>
                    </div>
                </div>
                <!-- </div> -->
