            ...
            <div class="card-item border ">
               <div class="row p-3">
                  <div class="col-md-6">
                     ...
                     <input class="form-control" id="firstName" name="first_name" type="text" required="" placeholder="First Name">
                  </div>
                  <div class="col-md-6">
                     <label class="form-label" for="lastName">Last Name</label>
                     <input class="form-control" id="lastName" name="last_name" type="text" required="" placeholder="Last Name">
                  </div>
                  <div class="col-md-6">
